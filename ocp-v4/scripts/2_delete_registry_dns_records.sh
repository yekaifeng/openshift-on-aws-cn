...
# create bastion.example.com record set in public hosted zone
aws route53 change-resource-record-sets --hosted-zone-id ${PublicHostedZoneId} --change-batch file://parameters/2_registry_dns_delete_records.json  --endpoint-url=https://route53.amazonaws.com.cn
