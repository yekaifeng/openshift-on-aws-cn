...
aws route53 change-resource-record-sets --hosted-zone-id ${PublicHostedZoneId} --change-batch file://parameters/2_registry_dns_records.json  --endpoint-url=https://route53.amazonaws.com.cn
